...
figure
plot(t_single_singal,Impulse);
title('Time domain Single Impulse')
xlabel('Time (s)')
...
grid on
title('Power Spectral Density Of Impulse')
xlabel('Frequency (Hz)')
...
figure
plot(t,allPulses);
title('Time domain All PulseTrans')
xlabel('Time (s)')
ylabel('Amplitude (dBm)')
...
figure
plot(t,receive_signals_without_noise);
title('Time domain Received Signals After Channel')
xlabel('Time (s)')
ylabel('Amplitude (dBm)')
...
figure;
plot(t,receive_signals);
title('Time domain Received Signals With Noise')
xlabel('Time (s)')
ylabel('Amplitude (dBm)')
...
fvtool(Conventional_FIR_Filter,1,'fs',fs);
...
figure
plot(t,SACF_Multiplication);
title('Multiplication Signal After Conventional Filter')
xlabel('Time (s)')
ylabel('Amplitude (dBm)')
...
%Matched FIR Filter
%Matched_Filter = PulseTran_Reference(1, 1: 1+ SymbolPoints);
...
figure
plot(t,SAMF_Multiplication);
title('Multiplication Signal After Matched Filter')
xlabel('Time (s)')
ylabel('Amplitude (dBm)')
